...
namespace Soenneker.DigitalOcean.OpenApiClient.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// <summary>The ID of the project the app should be assigned to. If omitted, it will be assigned to your default project.&lt;br&gt;&lt;br&gt;Requires `project:assign_resource` scope.</summary>
