...
using System;
namespace Soenneker.DigitalOcean.OpenApiClient.V2.Kubernetes.Clusters.Item.Destroy_with_associated_resources.Dangerous
{
    /// <summary>
    /// Builds and executes requests for operations under \v2\kubernetes\clusters\{clusterId}\destroy_with_associated_resources\dangerous
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class DangerousRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.DigitalOcean.OpenApiClient.V2.Kubernetes.Clusters.Item.Destroy_with_associated_resources.Dangerous.DangerousRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DangerousRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/kubernetes/clusters/{clusterId}/destroy_with_associated_resources/dangerous", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.DigitalOcean.OpenApiClient.V2.Kubernetes.Clusters.Item.Destroy_with_associated_resources.Dangerous.DangerousRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DangerousRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/kubernetes/clusters/{clusterId}/destroy_with_associated_resources/dangerous", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.DigitalOcean.OpenApiClient.V2.Kubernetes.Clusters.Item.Destroy_with_associated_resources.Dangerous.DangerousRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.DigitalOcean.OpenApiClient.V2.Kubernetes.Clusters.Item.Destroy_with_associated_resources.Dangerous.DangerousRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.DigitalOcean.OpenApiClient.V2.Kubernetes.Clusters.Item.Destroy_with_associated_resources.Dangerous.DangerousRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
