...
using System;
namespace Soenneker.DigitalOcean.OpenApiClient.V2.Registries.Item.Repositories.Item.Digests.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \v2\registries\{registryName}\repositories\{repositoryName}\digests\{manifestDigest}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithManifestDigestItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.DigitalOcean.OpenApiClient.V2.Registries.Item.Repositories.Item.Digests.Item.WithManifestDigestItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithManifestDigestItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/registries/{registryName}/repositories/{repositoryName}/digests/{manifestDigest}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.DigitalOcean.OpenApiClient.V2.Registries.Item.Repositories.Item.Digests.Item.WithManifestDigestItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithManifestDigestItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/registries/{registryName}/repositories/{repositoryName}/digests/{manifestDigest}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.DigitalOcean.OpenApiClient.V2.Registries.Item.Repositories.Item.Digests.Item.WithManifestDigestItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.DigitalOcean.OpenApiClient.V2.Registries.Item.Repositories.Item.Digests.Item.WithManifestDigestItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
