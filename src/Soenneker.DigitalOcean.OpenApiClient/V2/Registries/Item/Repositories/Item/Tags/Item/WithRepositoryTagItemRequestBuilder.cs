...
using System;
namespace Soenneker.DigitalOcean.OpenApiClient.V2.Registries.Item.Repositories.Item.Tags.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \v2\registries\{registryName}\repositories\{repositoryName}\tags\{repositoryTag}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithRepositoryTagItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.DigitalOcean.OpenApiClient.V2.Registries.Item.Repositories.Item.Tags.Item.WithRepositoryTagItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithRepositoryTagItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/registries/{registryName}/repositories/{repositoryName}/tags/{repositoryTag}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.DigitalOcean.OpenApiClient.V2.Registries.Item.Repositories.Item.Tags.Item.WithRepositoryTagItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithRepositoryTagItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/registries/{registryName}/repositories/{repositoryName}/tags/{repositoryTag}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.DigitalOcean.OpenApiClient.V2.Registries.Item.Repositories.Item.Tags.Item.WithRepositoryTagItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.DigitalOcean.OpenApiClient.V2.Registries.Item.Repositories.Item.Tags.Item.WithRepositoryTagItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
