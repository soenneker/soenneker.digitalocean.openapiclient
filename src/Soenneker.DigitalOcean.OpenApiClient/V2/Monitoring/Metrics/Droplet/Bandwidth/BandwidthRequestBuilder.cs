...
using System;
namespace Soenneker.DigitalOcean.OpenApiClient.V2.Monitoring.Metrics.Droplet.Bandwidth
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.DigitalOcean.OpenApiClient.V2.Monitoring.Metrics.Droplet.Bandwidth.BandwidthRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Soenneker.DigitalOcean.OpenApiClient.Models.Metrics?> GetAsync(Action<RequestConfiguration<global::Soenneker.DigitalOcean.OpenApiClient.V2.Monitoring.Metrics.Droplet.Bandwidth.BandwidthRequestBuilder.BandwidthRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.DigitalOcean.OpenApiClient.Models.Metrics> GetAsync(Action<RequestConfiguration<global::Soenneker.DigitalOcean.OpenApiClient.V2.Monitoring.Metrics.Droplet.Bandwidth.BandwidthRequestBuilder.BandwidthRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.DigitalOcean.OpenApiClient.V2.Monitoring.Metrics.Droplet.Bandwidth.BandwidthRequestBuilder.BandwidthRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.DigitalOcean.OpenApiClient.V2.Monitoring.Metrics.Droplet.Bandwidth.BandwidthRequestBuilder.BandwidthRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.DigitalOcean.OpenApiClient.V2.Monitoring.Metrics.Droplet.Bandwidth.BandwidthRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.DigitalOcean.OpenApiClient.V2.Monitoring.Metrics.Droplet.Bandwidth.BandwidthRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.DigitalOcean.OpenApiClient.V2.Monitoring.Metrics.Droplet.Bandwidth.BandwidthRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// To retrieve bandwidth metrics for a given Droplet, send a GET request to `/v2/monitoring/metrics/droplet/bandwidth`. Use the `interface` query parameter to specify if the results should be for the `private` or `public` interface. Use the `direction` query parameter to specify if the results should be for `inbound` or `outbound` traffic.The metrics in the response body are in megabits per second (Mbps).
        /// </summary>
        ...
        public partial class BandwidthRequestBuilderGetQueryParameters 
        {
            ...
            public global::Soenneker.DigitalOcean.OpenApiClient.Models.NetworkDirection? Direction { get; set; }
...
#nullable restore
            ...
            public global::Soenneker.DigitalOcean.OpenApiClient.Models.NetworkInterface? Interface { get; set; }
