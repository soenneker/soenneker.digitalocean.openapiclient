...
using System;
namespace Soenneker.DigitalOcean.OpenApiClient.V2.Droplets.Autoscale.Item.Dangerous
{
    /// <summary>
    /// Builds and executes requests for operations under \v2\droplets\autoscale\{autoscalePoolId}\dangerous
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class DangerousRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.DigitalOcean.OpenApiClient.V2.Droplets.Autoscale.Item.Dangerous.DangerousRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DangerousRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/droplets/autoscale/{autoscalePoolId}/dangerous", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.DigitalOcean.OpenApiClient.V2.Droplets.Autoscale.Item.Dangerous.DangerousRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DangerousRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/droplets/autoscale/{autoscalePoolId}/dangerous", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.DigitalOcean.OpenApiClient.V2.Droplets.Autoscale.Item.Dangerous.DangerousRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.DigitalOcean.OpenApiClient.V2.Droplets.Autoscale.Item.Dangerous.DangerousRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.DigitalOcean.OpenApiClient.V2.Droplets.Autoscale.Item.Dangerous.DangerousRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
