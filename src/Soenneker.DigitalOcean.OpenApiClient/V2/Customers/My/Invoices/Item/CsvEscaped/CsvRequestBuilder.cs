...
using System;
namespace Soenneker.DigitalOcean.OpenApiClient.V2.Customers.My.Invoices.Item.CsvEscaped
{
    /// <summary>
    /// Builds and executes requests for operations under \v2\customers\my\invoices\{invoiceUuid}\csv
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class CsvRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.DigitalOcean.OpenApiClient.V2.Customers.My.Invoices.Item.CsvEscaped.CsvRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CsvRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/customers/my/invoices/{invoiceUuid}/csv", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.DigitalOcean.OpenApiClient.V2.Customers.My.Invoices.Item.CsvEscaped.CsvRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CsvRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/customers/my/invoices/{invoiceUuid}/csv", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.DigitalOcean.OpenApiClient.V2.Customers.My.Invoices.Item.CsvEscaped.CsvRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.DigitalOcean.OpenApiClient.V2.Customers.My.Invoices.Item.CsvEscaped.CsvRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.DigitalOcean.OpenApiClient.V2.Customers.My.Invoices.Item.CsvEscaped.CsvRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
