...
using System;
namespace Soenneker.DigitalOcean.OpenApiClient.V2.Vpcs.Item.Peerings.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \v2\vpcs\{vpc-id}\peerings\{vpcPeeringId}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithVpcPeeringItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.DigitalOcean.OpenApiClient.V2.Vpcs.Item.Peerings.Item.WithVpcPeeringItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithVpcPeeringItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/vpcs/{vpc%2Did}/peerings/{vpcPeeringId}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.DigitalOcean.OpenApiClient.V2.Vpcs.Item.Peerings.Item.WithVpcPeeringItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithVpcPeeringItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/vpcs/{vpc%2Did}/peerings/{vpcPeeringId}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::Soenneker.DigitalOcean.OpenApiClient.Models.VpcPeeringResponse?> PatchAsync(global::Soenneker.DigitalOcean.OpenApiClient.Models.VpcsPatchPeeringsRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.DigitalOcean.OpenApiClient.Models.VpcPeeringResponse> PatchAsync(global::Soenneker.DigitalOcean.OpenApiClient.Models.VpcsPatchPeeringsRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::Soenneker.DigitalOcean.OpenApiClient.Models.VpcsPatchPeeringsRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::Soenneker.DigitalOcean.OpenApiClient.Models.VpcsPatchPeeringsRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.DigitalOcean.OpenApiClient.V2.Vpcs.Item.Peerings.Item.WithVpcPeeringItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.DigitalOcean.OpenApiClient.V2.Vpcs.Item.Peerings.Item.WithVpcPeeringItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
